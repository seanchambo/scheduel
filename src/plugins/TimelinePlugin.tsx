...
import { Resource, TicksConfig, Assignment, Event, ViewConfig, DragContext, ExternalDragContext, ResourceAssignmentMap, ResourceElement, TimelinePluginComponent } from "../models";
